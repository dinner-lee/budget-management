          ...
          <div className="flex items-center gap-3 flex-wrap min-w-0">
            ...
            {selectedCount > 0 && (
              ...
              {reviewableSelectedCount > 0 && (
                <>
                  <button
                    ...
                    className="inline-flex items-center gap-1 whitespace-nowrap shrink-0 text-xs font-medium text-green-600 border border-green-200 bg-green-50/50 rounded-lg px-2.5 py-1 hover:bg-green-50 hover:border-green-500/30 hover:shadow-sm transition-all disabled:opacity-60"
                  >
                    {bulkLoading ? (
                  ...
                  <button
                    ...
                    disabled={bulkLoading}
                    className="inline-flex items-center gap-1 whitespace-nowrap shrink-0 text-xs font-medium text-red-600 border border-red-200 bg-red-50/50 rounded-lg px-2.5 py-1 hover:bg-red-50 hover:border-red-500/30 hover:shadow-sm transition-all disabled:opacity-60"
                  >
              ...
              <button
                ...
                className="inline-flex items-center gap-1 whitespace-nowrap shrink-0 text-xs font-medium text-gray-500 border border-gray-200 bg-white rounded-lg px-2.5 py-1 hover:bg-red-50 hover:text-red-600 hover:border-red-200 hover:shadow-sm transition-all disabled:opacity-60"
              >
              ...
              <button
                ...
                disabled={bulkLoading}
                title="선택 해제"
                className="p-1 rounded-lg text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-colors disabled:opacity-60"
              >
